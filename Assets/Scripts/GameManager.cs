...
public class GameManager : MonoBehaviour
{
    ...
    {   
        ...
        _projectilePool = new ObjectPool<Projectile>(() =>
        {
            ...
            aux.Init(_playerT.transform, _projectilePool, _planetGen.GetPlanetTransform());
            return aux;
        }, proj =>
        {
        ...
        _enemyPool = new ObjectPool<EnemyController>(() =>
        {
            ...
            aux.Init(_projectilePool, _playerT.transform, _planetGen.GetPlanetTransform(), _wallMask);
            return aux;
        }, enemy =>
        {
